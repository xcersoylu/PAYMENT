  METHOD if_http_service_extension~handle_request.
    ...
    DATA lv_methodname TYPE c LENGTH 30 VALUE 'FILE_'.
    ...
    LOOP AT ms_request-header INTO DATA(ls_header) GROUP BY ( companybankcode = ls_header-companybankcode
      ...
      LOOP AT ms_request-items INTO DATA(ls_item) WHERE paymentnumber = ls_header-paymentnumber
        ...
        APPEND VALUE #( paymentnumber         = ls_item-paymentnumber
                        ...
                        suppliername          = ls_item-suppliername
...
*                        accountingdocumetitem = ls_item-accountingdocumentitem
                        ...
                        bankcountrykey        = ls_item-supplierbankcountrykey
                        banknumber            = ls_item-supplierbanknumber
                        bankaccount           = ls_item-supplierbankaccount
                        iban                  = ls_item-supplieriban
                        swiftcode             = ls_item-supplierswiftcode
                        bankname              = ls_item-supplierbankname
                        bankbranch            = ls_item-supplierbankbranch
      ...
      IF lo_bank IS BOUND.
*        lv_methodname = lv_methodname && ls_header-companybankinternalid.
*        lt_txt_file = lo_bank->(lv_methodname).
