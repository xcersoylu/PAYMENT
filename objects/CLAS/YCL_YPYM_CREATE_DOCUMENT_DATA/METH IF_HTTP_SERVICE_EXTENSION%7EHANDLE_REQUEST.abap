    ...
    IF sy-subrc = 0.
      ...
      LOOP AT ms_response-items INTO DATA(ls_item) GROUP BY ( paymentnumber = ls_item-paymentnumber
        ...
        LOOP AT GROUP ls_item INTO DATA(ls_member).
          COLLECT VALUE ypym_s_payment_save_doc_header( paymentnumber         = ls_member-paymentnumber
                                                        ...
                                                        paymentrequestdate    = ls_member-paymentrequestdate
                                                        companybankinternalid = ls_member-companybankinternalid
                                                        bankfilestatus        = ls_member-bankfilestatus ) INTO ms_response-header.
        ENDLOOP.
      ENDLOOP.
    ENDIF.
